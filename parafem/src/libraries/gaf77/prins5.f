...
c
c  PURPOSE  prints five values according to a C style format to an internal
c           character string.
c
...
c
c  (assuming i = 3, d = 16.49, j = 12, f = -0.03, and ierr = 0),
c  then this routine would be called as follows;
c
c	call prins5( sub,
c      >    'd(%i) = %f, f(%i) = %f (ierr = %i)',
c      >             i, d, j, f, ierr )
c
...
c-------------------------------------------------------------------------
      subroutine prins5( s, fmt, val1, val2, val3, val4, val5 )
      parameter (MP = 5)
      character*(*) fmt, s
