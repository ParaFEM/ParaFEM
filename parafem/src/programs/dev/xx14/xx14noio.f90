...
! no IO in this program, used for collecting scaling data
! dump space arrays to files, all images must call these routines
...
!call cgca_pswci( cgca_space, cgca_state_type_grain, "zg0mpiio.raw" )
!call cgca_pswci( cgca_space, cgca_state_type_frac,  "zf0mpiio.raw" )
...
! no IO in this program, used or collecting scaling data
