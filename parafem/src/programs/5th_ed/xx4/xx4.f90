 PROGRAM xx4
!------------------------------------------------------------------------------
!      program xx.4 three-d strain of an elastic-plastic(von Mises) solid
...
!------------------------------------------------------------------------------
  ...
  CALL bcast_inputdata_xx4(numpe,npes,element,meshgen,nels,nn,nr,nip,        &
                             plasitersMax,plasitersMin,loadIncrementMax,       &
                             cjits,plastol,cjtol,fftol,ltol,np_types,numSteps)
    
  CALL check_inputdata_xx4(numpe,npes,element,meshgen,nels,nn,nr,nip,        &
                             plasitersMax,plasitersMin,loadIncrementMax,       &
                             cjits,plastol,cjtol,fftol,ltol,np_types,numSteps)
