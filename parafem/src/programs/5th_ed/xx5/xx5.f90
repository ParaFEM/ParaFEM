 PROGRAM XX5
!------------------------------------------------------------------------------
!      program xx.5 three-d strain of an elastic-plastic(von Mises) solid
...
!INTEGER, PARAMETER   :: nod=20                ! no of nodes per element 
 ...
 CHARACTER(LEN=50)    :: program_name='xx5'
...
!------------------------------------------------------------------------------
  ...
  CALL bcast_inputdata_xx5(numpe,npes,element,meshgen,nels,nn,nr,nip,        &
                             plasitersMax,plasitersMin,loadIncrementMax,       &
                             cjits,plastol,cjtol,fftol,ltol,np_types,numSteps)
    
  CALL check_inputdata_xx5(numpe,npes,element,meshgen,nels,nn,nr,nip,        &
                             plasitersMax,plasitersMin,loadIncrementMax,       &
                             cjits,plastol,cjtol,fftol,ltol,np_types,numSteps)
