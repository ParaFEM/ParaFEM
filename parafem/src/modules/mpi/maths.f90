...
!------------------------------------------------------------------------------
  ...
  SUBROUTINE PCG_KM(diag_precon_pp,km,limit,nels_pp,r_pp,timest,tol,          &
                    xnew_pp,iters)
    ...
    !*
    !*    ieq_start                : Integer
    !*                             : Starting equation on each MPI process 
    !*
    !*    limit                    : Integer
    ...
    !*                             : Starting r_pp
    !*
    !*    store_pp(neq_pp)         : Real
    !*                             : Value of fixed freedoms
    !*
...
!------------------------------------------------------------------------------
  ...
  SUBROUTINE PCG_KM_GPU(limit,tol,km,nels_pp,diag_precon_pp,timest,           &
                        xnew_pp,iters)
