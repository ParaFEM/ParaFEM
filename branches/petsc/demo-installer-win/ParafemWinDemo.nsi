...
!define MUI_PRODUCT "ParaFEM Demonstrator"
...
!define MUI_WELCOMEPAGE_TEXT "Welcome to the ParaFEM Demonstrator installer. $\r$\n $\r$\nThis package will install a selection of programs that demonstrate the power of ParaFEM, the freely available portable library for parallel finite element analysis.$\r$\n $\r$\nParaView and the OpenMPI libraries will also be installed."
!define MUI_WELCOMEFINISHPAGE_BITMAP "parafem_logo_full.bmp"
!insertmacro MUI_PAGE_WELCOME

!insertmacro MUI_PAGE_LICENSE "..\parafem\license\parafem.lic"
...
Section "install"
	...
	File /r "parafem_logo_full.png"
	File /r "parafem_bg_fade.png"
	
	#Launcher
	File /r "demo-driver.hta"
	
	#License
	File /r "..\parafem\license\parafem.lic"
