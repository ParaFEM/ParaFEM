...
c
c  PURPOSE  prints four values according to a C style format to an internal
c           character string.
c
...
c-------------------------------------------------------------------------
      subroutine prins4( s, fmt, val1, val2, val3, val4 )
      parameter (MP = 4)
      character*(*) fmt, s
