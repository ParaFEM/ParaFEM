...
c
c-------------------------------------------------------------------------
      subroutine dmnsd(x,n,a,s,sa,sv)
...
c				sample standard deviation
      s  = 0.d0			! by default this is zero if n < 2
      sa = 0.d0			! by default this is zero if n < 2
      sv = 0.d0			! by default this is zero if n < 2
      if( n .gt. 1 ) then
         v = 0.d0
         do 20 i = 1, n
            d = x(i) - a
