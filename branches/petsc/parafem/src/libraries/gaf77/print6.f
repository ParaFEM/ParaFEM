...
c
c  PURPOSE  prints six values according to a C style format
c
...
c
c	call print6( 6,
c      >    'd(%i) = %f, f(%i) = %f (%i''th realization, ierr = %i)%n',
c      >             i, d, j, f, nsim, ierr )
c
...
c
c  NOTES:
c   1)	if more than 6 occurrences of the formats %f, %e or %i appear in
...
c-------------------------------------------------------------------------
      subroutine print6( k, fmt, val1, val2, val3, val4, val5, val6 )
      parameter (MP = 6)
      character fmt*(*)
