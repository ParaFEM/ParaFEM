...
#@executable=job.bgq.totalview.sh
#@job_type=bluegene
...
/gpfs/packages/ibm/toolworks/totalview.8.12.0-0/linux-power/bin/totalview $RUNJOB -a  --env-all --exe /gpfs/home/HCP010/lxm03/lxm77-lxm03/parafem/parafem/bin/xx12 --np 2 --args "xx12_tetcube"
