 ...
 *    This function allows you to replace pieces of text in a file. Instead of replacing all text
 *    found in the file, you have the extra option of replacing text after the x times of it occurring,
 *    and x times to replace the text after that occurrence.
 *
 *  Usage:
