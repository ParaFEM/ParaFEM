...
c
c  PURPOSE  prints one values according to a C style format to an internal
c           character string.
c
...
c  argument and prints it to the given string. For example, say you wish
c  to print the value of the variables `d'
c  to the string sub so that the string appears as
c
c	d = 16.49
c
c  (assuming d = 16.49), then this routine would be called
c  as follows;
c
c	call prins1( sub, 'd = %f', d )
c      >   
c
...
c
c    val1	the input argument. val1 can be either real or integer,
