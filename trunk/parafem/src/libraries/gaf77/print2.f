...
c
c  PURPOSE  prints two values according to a C style format
c
...
c  to print the values of the variables 'i' and `d' to unit 6 so that
c  the output appears as
c
c	d(3) = 16.49
c
c  (assuming i = 3 and d = 16.49), then this routine would be
c  called as follows;
c
c	call print2( 6, 'd(%i) = %f%n', i, d )
c
...
c
c  NOTES:
c   1)	if more than 2 occurrences of the formats %f, %e or %i appear in
