...
c  Written by Press etal., Numerical Recipes with some modifications
c  by Gordon A. Fenton, TUNS, 1994
c  Latest Update: May 9, 1994
c
c  PURPOSE  returns the Gamma distribution function for given x and parameters
c           alpha and beta.
c
c  This routine employs a series or partial fraction solution to compute
c  the cumulative probability associated with a variable following the
