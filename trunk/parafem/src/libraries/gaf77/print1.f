...
c
c  PURPOSE  prints one value according to a C style format
c
...
c  argument and prints it to the given unit. For example, say you
c  wish to print the variable d to unit 6 using the following format;
c
c	d = 16.49
c
c  (assuming d's value is 16.49), then this routine would be called as
c  follows;
c
c	call print1( 6, 'd = %f%n', d )
c
...
c
c     val	the input argument. val can be either real or integer,
...
c
c  NOTES:
c   1)	if more than 1 occurrence of the formats %f, %e or %i appear in
c	the format string, the argument value is repeatedly used (this may
