...
c   B(k1,k2,k3) coefficients. The processing is carried out by subroutine fft1d
c
...
c	(Jul 2/97)
c-----------------------------------------------------------------------------
      Subroutine dfft3d( A, ia, ja, B, ib, jb, m1, m2, m3, ta, tb, INV )
...
c				finally transform in the N1 direction
      do 50 j = 1,N2
      do 50 k = 1,N3
         call dfft1d( A(1,j,k), B(1,j,k), m1, INV )
  50  continue
