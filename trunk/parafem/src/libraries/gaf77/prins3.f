...
c
c  PURPOSE  prints three values according to a C style format to an internal
c           character string.
c
...
c  to print the values of the variables 'i', `d', and 'f'
c  to the string sub so that the string appears as
c
c	d(3) = 16.49, f = -0.03
c
c  (assuming i = 3, d = 16.49, and f = -0.03),
...
c-------------------------------------------------------------------------
      subroutine prins3( s, fmt, val1, val2, val3 )
      parameter (MP = 3)
      character*(*) fmt, s
