...
c  definite). Thus this routine calls the function DFACLD(A,ia,n) and
c  the subroutine DSLVLD(A,ia,n,b). If the matrix [W] is found to be
...
c-----------------------------------------------------------------------------
      real*8 function dsqnml( A, ia, W, iw, b, c, n, m )
