...
I have added limited functionality for generating meshes of 8-node hexahedral elements.  Using 8-node elements will result in no load file, and is incompatible with an indenter.  This is included only for users who wish to generate a cumbic mesh of 8-node hex elements with the scaling algorithm, but wish to add their own loading conditions later.  I think at the moment you need a ppm file at the same resolution as the dense mesh - sorry.
