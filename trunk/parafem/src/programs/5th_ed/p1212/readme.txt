  ...
  Program p1212.f90 computes the eigenvalues and eigenvectors of a 3d elastic
  ...
  2004.
    ...
    Usage: p1212 <job_name>
  
  
  NOTES
  
  p1212.f90 requires ARPACK. This distribution includes a copy of ARPACK. 
